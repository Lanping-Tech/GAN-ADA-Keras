...
from cub_data_processor import prepare_dataset
images_dir = './CUB_200_2011/images'
images_info_path = './CUB_200_2011/images.txt'
bboxes_info_path = './CUB_200_2011/bounding_boxes.txt'
train_test_split_path = './CUB_200_2011/train_test_split.txt'
train_dataset = prepare_dataset(images_dir, images_info_path, bboxes_info_path, train_test_split_path, 'train', batch_size, padding, image_size)
val_dataset = prepare_dataset(images_dir, images_info_path, bboxes_info_path, train_test_split_path, 'test', batch_size, padding, image_size)
